...
export const darkThemes: string[] = [
  "nord", "dark", "deepdark", "dracula", "anthropic", "gruvbox", 
  "tokyonight", "catppuccin", "everforest_dark", "material_ocean", 
  "onedark", "aura"
];

export const lightThemes: string[] = [
  "light", "nord_light", "gruvbox_light", "github_light", "rosepine_dawn", 
  "catppuccin_latte", "tokyonight_day", "solarized_light", "everforest_light", 
  "soft_warm", "high_contrast_light"
];
